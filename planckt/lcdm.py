# -*- coding: utf-8 -*-
"""
Contains the Planck's 2018 results for the base-LCDM model (table 2 of
arXiv:1807.06209).

"""


# Here are some conventions applied to the names of the keys in params_dict:
#
# - A double underscore "__" in the name of a parameter means a multiplication
#   between two variables.
# - Superscripts are preceded by the symbol "^" unless the superscript is a
#   number. In that last case, the superscript and the variable preceding it
#   are joined without any space between them.
# - Subscripts are preceded by single underscores "_".
...
params_dict = {
    "Omega_b__h2": {
        ...
        "EE+lowE": {"value": 0.024, "limits68": [0.0012, 0.0012]},
    ...
    "ln(10^10A_s)": {
        "TT+lowE": {"value": 3.04, "limits68": [0.016, 0.016]},
    ...
    "n_s": {
        ...
        "EE+lowE": {"value": 0.98, "limits68": [0.015, 0.015]},
    ...
    "k_D": {
        ...
        "TT,TE,EE+lowE": {"value": 0.1409, "limits68": [0.00032, 0.00032]},
